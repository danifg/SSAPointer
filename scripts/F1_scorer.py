...
if __name__ == "__main__":
    ...
    parser.add_argument("--experiments", "-e", nargs="+", default=["point_to_root", "head_first", "head_first-inside_label", "head_final", "head_final-inside_label", "head_final-inside_label-dep_edges", "head_final-inside_label-dep_edges-dep_labels","syntax"])

    args = parser.parse_args()

    mapping = {'exp-Negative': "exp", 'exp-negative': "exp",  'exp-Neutral': "exp",'IN:exp-Neutral':"exp", 'IN:exp-neutral': "exp", 'exp-neutral': "exp", 'IN:exp-Negative': "exp", 'IN:exp-negative': "exp", 'targ': "targ", 'exp-positive': "exp", 'exp-Positive': "exp", 'IN:exp-Positive': "exp", 'IN:exp-positive': "exp", 'holder': "holder", 'IN:targ': "targ", 'IN:holder': "holder", 'IN:exp-None': "exp", 'exp-None': "exp", "exp-conflict": "exp", "IN:exp-conflict": "exp", "O": "O"}
    ...
    for setup in args.experiments:
        ...
        goldfile=args.golddir
        predfile=args.preddir
