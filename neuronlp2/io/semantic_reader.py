...
class CoNLLXReader(object):
    def __init__(self, file_path, bert_path, bert_dim, word_alphabet, char_alphabet, pos_alphabet, type_alphabet, lemma_alphabet):
	...
	debug=False
        ...
        return DependencyInstance(Sentence(words, word_ids, lemmas, lemma_ids, char_seqs, char_id_seqs), bert_embs, postags, pos_ids, heads, types, type_ids)
